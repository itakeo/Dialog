const Dialog = (function(win,doc){
    win.addEventListener('load',function(){doc.body.addEventListener('touchstart',function(){},false); },false);
    class DialogFn{
        constructor(obj) {
            this.timer = null;
            this.set = {};
        ...
        init(a,b,c){
            ...
            let _dialog = doc.createElement('div'),
            ...
            if(set.button) {
                ...
                ;[].forEach.call(btnArr,o =>{
                    ...
                    o.onclick = function(e){
                        e.preventDefault();
                        set.button[o.dataset.name].call(item,item);
                    }
                })
            }; 
            if(set.time) 
    ...
    win._D_obj = {
        ...
        close : function(index,fn) {
            let _dialog = doc.querySelectorAll('.c_alert_dialog');
